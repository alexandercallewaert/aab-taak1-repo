...
This document will be used for our final lab report.  It consists of the following parts:
1.  Loading the Data
2.  Preprocessing
  i) Missing data
  ii) Exploratory analysis
  iii) Imputing missing values
  iv) Completing the datasets (train & test)
...
-- AC:  ik denk dat voor de gevallen waar dit voorkomt (beide kolommen niet aan elkaar gelijk) we moeten aannemen dat het gewoon data quality probleem is (menselijke fout ofzo)
...
RFmodel <- randomForest(
  ...
  data = train2,
  ntree = 1000)
>>>>>>> 4c4bda8278072632122cc471b21735450ce611f5
