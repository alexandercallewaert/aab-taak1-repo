...
ggplot(data = train_ready2, mapping = aes(x = fraud, y = claim_amount)) + 
  geom_boxplot(mapping = aes(group = cut_width(claim_amount, 7500)))

ggplot(data = train_ready2) +
  geom_point(mapping = aes(x = claim_num_vehicles, y = claim_amount))
```
